...
These project contains all the exercises from the [**“Learn Python 3 the Hard Way”**](https://learnpythonthehardway.org/). 

Before, I start to code in Python. I knew that Python is called **“executable pseudo code”**. 
